...
var defaultTaskConfig = map[string]map[string]any{
	"寄养":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"悬赏":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"弥助":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"勾协":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"探索突破":    {"enabled": true, "sub_explore": true, "sub_tupo": true, "stamina_threshold": 1000, "difficulty": "normal", "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"结界卡合成":   {"enabled": true, "explore_count": 0},
	"加好友":     {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"领取登录礼包":  {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"领取邮件":    {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"爬塔":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"逢魔":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"地鬼":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"道馆":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"寮商店":     {"enabled": true, "next_time": "2020-01-01 00:00", "buy_heisui": true, "buy_lanpiao": true, "fail_delay": 30},
	"领取寮金币":   {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"每日一抽":    {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
	"每周商店":    {"enabled": true, "next_time": "2020-01-01 00:00", "buy_lanpiao": true, "buy_heidan": true, "buy_tili": true, "fail_delay": 30},
	"秘闻":      {"enabled": true, "next_time": "2020-01-01 00:00", "fail_delay": 30},
